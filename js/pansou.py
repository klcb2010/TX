...
class CloudSearchSpider(Spider):
    ...
    def detailContent(self, did):
        ...
        resource_url = self._normalize_url(did[0])   # 修复
        ...
        result['list'].append({
            ...
            "vod_pic": pan_icon,
            "vod_play_from": "盘搜",
            "vod_play_url": f"盘搜$push:{resource_url}",   # 修复
    ...
    def _parse_and_sort_results(self, data, keywords):
        ...
        for cloud_type, items in merged_data.items():
            ...
            for item in items:
                ...
                resource_url = self._normalize_url(resource_url)   # 关键修复
    ...
    def playerContent(self, flag, pid, vipFlags):
        ...
        url = self._normalize_url(pid.strip())   # 修复
